...
type Like struct {
	...
	User         *common.SimpleUser `json:"user,omitempty"`
}
...
func ErrorHasBeenExisted(err error) *common.AppError {
	return common.NewCustomError(
		err,
		fmt.Sprintf("this restaurant has been like"),
		fmt.Sprintf("ErrCannotlikeRestaurant"),
	)
}

func ErrorHasBeenUnlike(err error) *common.AppError {
	return common.NewCustomError(
		err,
		fmt.Sprintf("this restaurant has been unlike"),
		fmt.Sprintf("ErrCannotlikeRestaurant"),
	)
}
